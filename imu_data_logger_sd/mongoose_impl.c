...
struct attribute s_settings_attributes[] = {
  {"read_interval", "int", NULL, offsetof(struct settings, read_interval), 40, false},
  {"Send_Interval", "int", NULL, offsetof(struct settings, Send_Interval), 10, false},
...
struct attribute s_acceleration_attributes[] = {
  {"z", "double", NULL, offsetof(struct acceleration, z), 0, false},
  {"y", "double", NULL, offsetof(struct acceleration, y), 0, false},
  {"x", "double", NULL, offsetof(struct acceleration, x), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_gyo_attributes[] = {
  {"z", "double", NULL, offsetof(struct gyo, z), 0, false},
  {"x", "double", NULL, offsetof(struct gyo, x), 0, false},
  {"y", "double", NULL, offsetof(struct gyo, y), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_angle_attributes[] = {
  {"roll", "double", NULL, offsetof(struct angle, roll), 0, false},
  {"pitch", "double", NULL, offsetof(struct angle, pitch), 0, false},
  {"yaw", "double", NULL, offsetof(struct angle, yaw), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_state_attributes[] = {
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_chart_attributes[] = {
  {"level__", "int", NULL, offsetof(struct chart, level__), 0, false},
  {"level_", "int", NULL, offsetof(struct chart, level_), 0, false},
  {"level", "int", NULL, offsetof(struct chart, level), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
...
struct apihandler_custom s_apihandler_graph_data = {{"graph_data", "custom", false, 0, 0, 0UL}, glue_reply_graph_data};
struct apihandler_custom s_apihandler_acc_chart = {{"acc_chart", "custom", false, 0, 0, 0UL}, glue_reply_acc_chart};
struct apihandler_custom s_apihandler_angle_chart = {{"angle_chart", "custom", false, 0, 0, 0UL}, glue_reply_angle_chart};
struct apihandler_custom s_apihandler_gyo_chart = {{"gyo_chart", "custom", false, 0, 0, 0UL}, glue_reply_gyo_chart};
struct apihandler_data s_apihandler_acceleration = {{"acceleration", "data", false, 0, 0, 0UL}, s_acceleration_attributes, sizeof(struct acceleration), (void (*)(void *)) glue_get_acceleration, (void (*)(void *)) glue_set_acceleration};
struct apihandler_data s_apihandler_gyo = {{"gyo", "data", false, 0, 0, 0UL}, s_gyo_attributes, sizeof(struct gyo), (void (*)(void *)) glue_get_gyo, (void (*)(void *)) glue_set_gyo};
struct apihandler_data s_apihandler_angle = {{"angle", "data", false, 0, 0, 0UL}, s_angle_attributes, sizeof(struct angle), (void (*)(void *)) glue_get_angle, (void (*)(void *)) glue_set_angle};
...
struct apihandler_data s_apihandler_chart = {{"chart", "data", false, 0, 0, 0UL}, s_chart_attributes, sizeof(struct chart), (void (*)(void *)) glue_get_chart, (void (*)(void *)) glue_set_chart};
...
static struct apihandler *s_apihandlers[] = {
  ...
  (struct apihandler *) &s_apihandler_acc_chart,
  (struct apihandler *) &s_apihandler_angle_chart,
  (struct apihandler *) &s_apihandler_gyo_chart,
  (struct apihandler *) &s_apihandler_acceleration,
  (struct apihandler *) &s_apihandler_gyo,
  (struct apihandler *) &s_apihandler_angle,
  (struct apihandler *) &s_apihandler_state,
  (struct apihandler *) &s_apihandler_chart
};
