...
#define WIZARD_MDNS_NAME "jy901s"
...
void glue_reply_acc_chart(struct mg_connection *, struct mg_http_message *);
void glue_reply_angle_chart(struct mg_connection *, struct mg_http_message *);
void glue_reply_gyo_chart(struct mg_connection *, struct mg_http_message *);
struct acceleration {
  double z;
  double y;
  double x;
};
void glue_get_acceleration(struct acceleration *);
void glue_set_acceleration(struct acceleration *);
...
void glue_get_gyo(struct gyo *);
void glue_set_gyo(struct gyo *);
...
void glue_get_angle(struct angle *);
void glue_set_angle(struct angle *);
...
void glue_get_chart(struct chart *);
void glue_set_chart(struct chart *);
