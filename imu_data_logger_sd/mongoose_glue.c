...
static struct settings s_settings = {1000, 1000, 17, true};
...
extern const char *log_value;
void glue_reply_events(struct mg_connection *c, struct mg_http_message *hm) {
  const char *headers = "Cache-Control: no-cache\r\n" "Content-Type: application/json\r\n";
  //const char *value = "[{\"timestamp\":1738653279,\"x\":0,\"y\":0,\"z\":0,\"d\":\"accel\"},
  //{\"timestamp\":1738653279,\"x\":0,\"y\":0,\"z\":0,\"d\":\"gyo\"},{\"timestamp\":1738653279,\"x\":0,\"y\":0,\"z\":0,\"d\":\"mag\"},{\"timestamp\":1738653279,\"x\":0,\"y\":0,\"z\":0,\"d\":\"gforce\"},{\"timestamp\":1738653279,\"x\":0,\"y\":0,\"z\":0,\"d\":\"linacc\"},{\"timestamp\":1738653279,\"x\":0,\"y\":0,\"z\":0,\"d\":\"gravity\"},{\"timestamp\":1738653279,\"x\":0,\"y\":0,\"z\":0,\"d\":\"rotation\"},{\"timestamp\":1738653279,\"x\":0,\"y\":0,\"z\":0,\"d\":\"orientation\"}]";
  (void) hm;
  mg_http_reply(c, 200, headers, "%s\n", log_value);
}
...
void glue_reply_graph_data(struct mg_connection *c, struct mg_http_message *hm) {
  const char *headers = "Cache-Control: no-cache\r\n" "Content-Type: application/json\r\n";
  const char *value = "[\"entry1\",\"entry2\"]";
  (void) hm;
  mg_http_reply(c, 200, headers, "%s\n", value);
}
void glue_reply_acc_chart(struct mg_connection *c, struct mg_http_message *hm) {
  const char *headers = "Cache-Control: no-cache\r\n" "Content-Type: application/json\r\n";
  //const char *value = "[[1724576787,20.3,34.3,56.8],[1724576847,27.2],[1724576907,29.7],[1724576967,27.9],[1724577027,25.1],[1724577087,23.8],[1724577147,22.5],[1724577207,22.2],[1724577267,23.3],[1724577327,23.9]]";
  (void) hm;
  mg_http_reply(c, 200, headers, "%s\n", value);
}
void glue_reply_angle_chart(struct mg_connection *c, struct mg_http_message *hm) {
  const char *headers = "Cache-Control: no-cache\r\n" "Content-Type: application/json\r\n";
  //const char *value = "[[1724576787,20.3,34.3,56.8],[1724576847,27.2],[1724576907,29.7],[1724576967,27.9],[1724577027,25.1],[1724577087,23.8],[1724577147,22.5],[1724577207,22.2],[1724577267,23.3],[1724577327,23.9]]";
  (void) hm;
  mg_http_reply(c, 200, headers, "%s\n", value);
}
void glue_reply_gyo_chart(struct mg_connection *c, struct mg_http_message *hm) {
  const char *headers = "Cache-Control: no-cache\r\n" "Content-Type: application/json\r\n";
...
static struct acceleration s_acceleration = {0, 0, 0};
void glue_get_acceleration(struct acceleration *data) {
  *data = s_acceleration;  // Sync with your device
}
void glue_set_acceleration(struct acceleration *data) {
  s_acceleration = *data; // Sync with your device
}

static struct gyo s_gyo = {0, 0, 0};
void glue_get_gyo(struct gyo *data) {
  *data = s_gyo;  // Sync with your device
}
void glue_set_gyo(struct gyo *data) {
  s_gyo = *data; // Sync with your device
}

static struct angle s_angle = {0, 0, 0};
void glue_get_angle(struct angle *data) {
  *data = s_angle;  // Sync with your device
}
void glue_set_angle(struct angle *data) {
  s_angle = *data; // Sync with your device
}
...
static struct chart s_chart = {0, 0, 0};
void glue_get_chart(struct chart *data) {
  *data = s_chart;  // Sync with your device
}
void glue_set_chart(struct chart *data) {
  s_chart = *data; // Sync with your device
}
